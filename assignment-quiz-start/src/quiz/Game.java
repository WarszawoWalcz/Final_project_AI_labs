...
public class Game {
    public void play() {
        ...
        questions.add(new OpenQuestion ("How many roads must a man walk down?", "42", 5));
        ...
        for (int round = 1; round <=2; round++) {
            for (Question q : questions) {
                ...
                if (q.isCorrect(answer)) {
                    System.out.println("Good answer. +" + q.getScore() + " points");
            ...
            if (round == 1) {
                for (int i = indexList.size(); i-- > 0; ) {
                    assert indexList != null : "indexList is currently empty (null)";
                    int k = indexList.get(i);
                    questions.remove(k);
                }
        ...
        System.out.println("End of the game! Your total score is: " + totalScore);
    }
}
